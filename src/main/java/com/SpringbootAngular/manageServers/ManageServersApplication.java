package com.SpringbootAngular.manageServers;

import com.SpringbootAngular.manageServers.model.Server;
import com.SpringbootAngular.manageServers.repo.ServerRepo;
import org.springframework.boot.CommandLineRunner;
import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import org.springframework.context.annotation.Bean;

import static com.SpringbootAngular.manageServers.enumeration.Status.*;
...
public class ManageServersApplication {
	...
	CommandLineRunner run(ServerRepo serverRepo) {
		return args -> {
			serverRepo.save(new Server(null, "192.168.56.1", "Ubuntu Linux", "16 GB", "Personal PC", "http://localhost:8080/server/image/server1.png", SERVER_UP));
